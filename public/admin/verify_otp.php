...
<head>
    ...
    <title><?= htmlspecialchars($tr['otp_verification'] ?? 'OTP Verification') ?> - Admin</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="secure-container">
            ...
            <?php endif; ?>
            <form method="POST" action="../../src/controllers/VerifyOtpAdminController.php" class="needs-validation" novalidate>
            ...
            <div class="text-center mt-3">
                <form method="POST" action="../../src/controllers/ResendOtpAdminController.php">
                    <input type="hidden" name="csrf_token" value="<?php echo $token; ?>">
